                            ...
                            <div class="card overflow-hidden">
                                <div class="row g-0">
                                    <div class="col-lg-6 bg-primary d-flex justify-content-center align-content-center">
                                        <img class="img-fluid" src="{{ URL::asset('assets/images/auth/auth.jpeg') }}" alt="">
                                    </div>
                                    <!-- end col -->
                                            ...
                                            <div class="mt-4">
                                                <form action="index.html">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control bg-body" id="username" placeholder="Enter username">
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                                            <input type="password" class="bg-body form-control pe-5 password-input" placeholder="Enter password" id="password-input">
